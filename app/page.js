      ...
      <footer style={{ background: '#061209', borderTop: '1px solid #1a4a20', padding: '3rem 2rem' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              <div style={{ color: '#c9911a', fontWeight: 'bold', marginBottom: '0.8rem', fontSize: '1rem' }}>
                Chief Emeka Agba Foundation
              </div>
            ...
            <div>
              ...
              {[
                ...
                <a key={l.href} href={l.href}
                  style={{ display: 'block', color: '#7a9e7a', fontSize: '0.85rem', marginBottom: '0.4rem' }}
                  onMouseOver={e => e.target.style.color = '#c9911a'}
                  onMouseOut={e => e.target.style.color = '#7a9e7a'}>
                  {l.label}
                </a>
              ))}
            </div>
            ...
            <div>
              <div style={{ color: '#c9911a', fontWeight: 'bold', marginBottom: '0.8rem' }}>
                Partners & Sponsors
              </div>
              <p style={{ color: '#7a9e7a', fontSize: '0.85rem', lineHeight: 1.7 }}>
                Interested in partnering?{' '}
                <a href="/donor-portal" style={{ color: '#c9911a' }}>
          ...
          <div style={{
            ...
            <p style={{ color: '#3a5a3a', fontSize: '0.8rem' }}>
              © {new Date().getFullYear()} Chief Emeka Agba Foundation. All rights reserved.
            </p>
            <div style={{ display: 'flex', gap: '1.5rem' }}>
              <a href="/privacy-policy"
                style={{ color: '#3a5a3a', fontSize: '0.8rem' }}
                onMouseOver={e => e.target.style.color = '#c9911a'}
                onMouseOut={e => e.target.style.color = '#3a5a3a'}>
                Privacy Policy
              </a>
